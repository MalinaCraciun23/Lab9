...
@NamedQueries({
    ...
    @NamedQuery(name = "Album.findByArtist", query = "SELECT a FROM Album a WHERE a.artistId.id = :artistId")})
public class Album implements Serializable {
    ...
    public Album(String name, Integer releaseYear, Artist artistId) {
        this.name = name;
